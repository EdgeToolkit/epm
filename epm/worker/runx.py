...
#
#    def __init__(self, name, project=None, workbench=None):
#        self.defination = ExtensionDefinition.load(name, project, workbench)
#        if self.defination.prototype:
#            path = os.path.expanduser(f'~/.epm/.prototype')
#        else:
#            path = self.defination.attribute.dir
#        self.prototype = Prototype(path)
...
class RunX(Worker):
    ...
    def __init__(self, name, project=None, api=None):
        ...
        from tools.extension import Definition
